...
export default function ContactPage() {
  return (
    <div className="pt-[116px]">
      <Seo
        title="Admission & Contact - Sunrise Classes Champanagar Purnia Bihar | Call 9973152070"
        description="Sunrise Classes & Academy, Champanagar Purnia Bihar — Class 8, 9 & 10 coaching admission open. Contact SP Jha sir: 9973152070 / 7979732764. Visit us in Champanagar near cinema hall."
