  ...
  return (
    <div className="pt-[116px]">
      <Seo
        ...
        description="Discover top achievers from Sunrise Classes & Academy, Champanagar Purnia Bihar. Year-wise board exam success stories, Class 8, 9 & 10 toppers, high scorers, and real student results."
